...
Kubernetes uses namespaces as a mechanism to separate objects within a cluster. We will create the namespace my-cnf to for all configuration used in the demo.
